        ...
        private void CreateAllEvents()
        {
            ...
            // 6 : Everyone dead
            {
                ...
                string text = "Move: WASD\n" +
                              ...
                              "\n\n" +
                              "Holding Shift down: \tDisable building snapping\n" +
                              "\t\t\t\t\t\t\t\tQueue actions\n" +
                              "\n\n" +
                              "Wood: \n\n" +
                              "Metal: Metal is used to build buildings. Metal can be found in some of the barrels drifting in the sea.\n\n" +
                              ...
                              "Plastic: Plastic is used as a building material and can be found by looting barrels found drifting in the sea.\n" +
